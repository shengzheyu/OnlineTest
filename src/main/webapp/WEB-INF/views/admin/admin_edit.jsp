<%@ page import="com.ncut.ssm.pojo.Admin" %>
<%--
    ...
    function submit_form(obj){
      ...
      layer.confirm('确认修改？',function(index){
        ...
        $.ajax({
          url:"/admin/AdminEdit",
          type:"POST",
          data:{adminid:adminid,username:username,loginname:loginname,loginpass:loginpass,phone:phone,age:age,remark:"remark",email:email,sex:sex},//,sex:sex,
          dataType:"String",
          async:false,
          cache:false,
          success:function(result){
            if(result.equals("EditAdminSuccess")){
              return true;
            }else {
              return false;
            }
...
<body>
<div class="pd-20">
  <form action="/admin/AdminEdit" method="post" class="form form-horizontal" id="form-admin-add">

    <div class="row cl" style="display: none">
      <label class="form-label col-3"><span class="c-red">*</span>AdminId：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<%=adminId%>" placeholder="" id="adminid" name="adminid" datatype="*2-16" nullmsg="AdminId不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<%=admin.getName()%>" placeholder="" id="username" name="username" datatype="*2-16" nullmsg="用户名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl" >
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<%=admin.getAdminnum()%>" placeholder="" id="loginname" name="loginname" datatype="*2-16" nullmsg="登陆名不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="password" id="loginpass" name="loginpass" placeholder="密码" autocomplete="off" value="" class="input-text" datatype="*6-20" nullmsg="密码不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="password" placeholder="确认密码" value="" autocomplete="off" class="input-text Validform_error" errormsg="您两次输入的新密码不一致！" datatype="*" nullmsg="请再输入一次新密码！" recheck="loginpass" id="reloginpass" name="reloginpass">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" id="age" name="age" placeholder="年龄" autocomplete="off" value="<%=admin.getAge()%>" class="input-text" errormsg="你是王八？" datatype="*2-3" nullmsg="年龄不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5 skin-minimal">
        <div class="radio-box">
          <input type="radio" id="sex-1" checked="checked" name="sex" datatype="*" nullmsg="请选择性别！">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<%=admin.getPhone()%>" placeholder="" id="phone" name="phone"  datatype="m" nullmsg="手机不能为空">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<%=admin.getEmail()%>" placeholder="xx@xx.xx" name="email" id="email" datatype="e" nullmsg="请输入邮箱！">
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
