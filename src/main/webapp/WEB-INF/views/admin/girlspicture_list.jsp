...
<%@ page import="com.ncut.ssm.pojo.HotGirlGroup" %>
...
<%
  ...
  List<HotGirlGroup> hotGirlGroup = (List<HotGirlGroup>)request.getAttribute("hotGirlGroup");
  int groupCount = Integer.valueOf(request.getAttribute("groupCount").toString());
  int i =0;
%>
<html>
<head>
...
<div class="pd-20">
  ...
  <div class="mt-20">
    <table class="table table-border table-bordered table-bg table-hover table-sort">
      ...
      <tbody>
      <%
        for(HotGirlGroup hotGirlGroup1 :hotGirlGroup)
        {
          i++;
      %>
      <tr class="text-c">
        ...
        <td>001</td>
        <td>分类名称</td>
        <td><a href="" onClick="picture_zy()"><img width="100" class="picture-thumb" src="/olt/images/gq/gj.png"></a></td>
        <td class="text-l" align="center"><div align="CENTER"> <a class="maincolor" href="/admin/showGirlsPic?groupnum=<%=i%>" ><%=hotGirlGroup1.getHotgirlgroupname()%></a></div></td>
        <td class="text-c">HotGirl</td>
        <td ><%=NowTime%></td>
...
<script type="text/javascript">
  ...
  function picture_zy(){
    layer.open({
      type: 1,
      title: zyzyzyzyzyzzyzyzyzzy,
      closeBtn: 0,
      area: '516px',
      skin: 'layui-layer-nobg', //没有背景色
      shadeClose: true,
      content: $('#picture-thumb')
    });
  }
  /*图片-删除*/
