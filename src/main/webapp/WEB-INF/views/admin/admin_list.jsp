...
<head>
  ...
  <!--[if IE 6]>
  <script type="text/javascript" src="/olt/lib/DD_belatedPNG_0.0.8a-min.js" ></script>
...
<div class="pd-20">
  ...
  <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加管理员','AdminAddJump','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong><%=AdminNum%></strong> 条</span> </div>
  <table class="table table-border table-bordered table-bg">
    ...
    <tr class="text-c">
      ...
      <td><%=i%></td>
      <td><%=adminList.getAdminnum()%></td>
      <td><%=adminList.getName()%></td>
      <td><%=adminList.getAge()%></td>
      <td>管理员</td>
      <td><%=adminList.getJointime()%></td>
      <td class="td-status"><span class="label label-success radius">已启用</span></td>
      <td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','/admin/AdminEditJump?adminId=<%=adminList.getAdminid()%>','19930511','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_del(this,'<%=adminList.getAdminnum()%>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
    </tr>
    <%
      }
    %>
...
<script type="text/javascript" src="/olt/lib/laypage/1.2/laypage.js"></script>
...
<script type="text/javascript">
  ...
  /*管理员-删除*/
  function admin_del(obj,adminNum){
    layer.confirm('确认要删除吗？',function(index){
      ...
      $.ajax({
        ...
        success:function(result){
          if(result.equals("DeleteAdminSuccess")){
            return true;
          }else {
            return false;
          }
