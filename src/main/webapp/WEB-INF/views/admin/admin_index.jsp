...
<head>
  ...
  <LINK rel="Bookmark" href="/olt/favicon.ico" >
  <LINK rel="Shortcut Icon" href="/olt/favicon.ico" />
  <!--[if lt IE 9]>
  ...
  <link href="/olt/skin/default/skin.css" rel="stylesheet" type="text/css" id="skin" />
  ...
  <![endif]-->
  <title>在线考试系统：管理员界面</title>
</head>
<body>
<header class="Hui-header cl"> <a class="Hui-logo l" title="OnlineTest.admin v1.0,这部分的点击跳转因为没有登录数据会跳转失败" href="">OnlineTest</a> <a class="Hui-logo-m l" href="" title="H-ui.admin">Online-Test</a> <span class="Hui-subtitle l">V1.0</span>
  <nav class="mainnav cl" id="Hui-nav" >
    <ul>
      <li class="dropDown dropDown_click" ><a href="javascript:;" class="dropDown_A" ><i class="Hui-iconfont">&#xe600;</i><label clsss="addNew">新增</label>  <i class="Hui-iconfont">&#xe6d5;</i></a>
...
<aside class="Hui-aside">
  ...
  <div class="menu_dropdown bk_2">
    ...
    <dl id="menu-picture">
      ...
      <dd>
        <ul>
          <li><a _href="/admin/showGirlsPicList" href="javascript:void(0)">图片列表</a></li>
        </ul>
      </dd>
    </dl>
    <dl id="menu-product">
    ...
    <dl id="menu-member">
      ...
      <dd>
        <ul>
          <li><a _href="/admin/Test" href="javascript:;">会员列表</a></li>
